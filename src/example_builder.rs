...
pub mod types {
    ...
    pub struct TwoBody {
        ...
        pub frontdoor: ::std::option::Option<::std::string::String>,
        #[serde(default, skip_serializing_if = "::std::option::Option::is_none")]
        pub gateway: ::std::option::Option<::std::string::String>,
    }
    impl ::std::convert::From<&TwoBody> for TwoBody {
        fn from(value: &TwoBody) -> Self {
            value.clone()
        }
    }
    impl TwoBody {
        pub fn builder() -> builder::TwoBody {
            Default::default()
        }
    }
    ///`UnoBody`
    ...
    pub mod builder {
        ...
        impl ::std::default::Default for TwoBody {
            fn default() -> Self {
                Self {
                    frontdoor: Ok(Default::default()),
                    gateway: Ok(Default::default()),
                }
            }
        }
        impl TwoBody {
            pub fn frontdoor<T>(mut self, value: T) -> Self
            where
                T: ::std::convert::TryInto<::std::option::Option<::std::string::String>>,
                T::Error: ::std::fmt::Display,
            {
                self.frontdoor = value
                    .try_into()
                    .map_err(|e| format!("error converting supplied value for frontdoor: {}", e));
                self
            }
        ...
        impl ::std::convert::TryFrom<TwoBody> for super::TwoBody {
        ...
        impl ::std::convert::From<super::TwoBody> for TwoBody {
            fn from(value: super::TwoBody) -> Self {
                Self {
                    frontdoor: Ok(value.frontdoor),
...
impl Client {
    /**Sends a `GET` request to `/two`

    ```ignore
    let response = client.two()
        .body(body)
        .send()
        .await;
    ```*/
    pub fn two(&self) -> builder::Two<'_> {
        builder::Two::new(self)
    }
...
pub mod builder {
    ...
    /**Builder for [`Client::two`]

    [`Client::two`]: super::Client::two*/
    #[derive(Debug, Clone)]
    pub struct Two<'a> {
        client: &'a super::Client,
        body: Result<types::builder::TwoBody, String>,
    }
    impl<'a> Two<'a> {
        ...
        where
            V: std::convert::TryInto<types::TwoBody>,
            <V as std::convert::TryInto<types::TwoBody>>::Error: std::fmt::Display,
        {
            self.body = value
                .try_into()
                .map(From::from)
                .map_err(|s| format!("conversion to `TwoBody` for body failed: {}", s));
            self
        }
        pub fn body_map<F>(mut self, f: F) -> Self
        where
            F: std::ops::FnOnce(types::builder::TwoBody) -> types::builder::TwoBody,
        {
        ...
        pub async fn send(self) -> Result<ResponseValue<ByteStream>, Error<()>> {
            ...
            dbg!(&body);
            let body = body
                .and_then(|v| types::TwoBody::try_from(v).map_err(|e| e.to_string()))
                .map_err(Error::InvalidRequest)?;
            let url = format!("{}/two", client.baseurl,);
